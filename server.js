...
console.log("|        |  _____|                      | |                                            |");
console.log("|        | |___     __ ___ __   ______  | |  ______   _    _   ______   ______         |");
console.log("|        |  ___|   |  _   _  | |  __  | | | |  __  | | |  | | |  __  | |  __  |        |");
console.log("|        | |_____  | | | | | | | |__| | | | | |__| | | |__| | |  ____| |  ____|        |");
console.log("|        |_______| |_| |_| |_| |  ____| |_| |______| |____  | |______| |______|        |");
console.log("|                              | |                    ____| |                          |");
...
console.log("|          | | |_| | | |  __  | |  __  | |  __  | |  __  | |  __  | |  ____|           |");
console.log("|          | |     | | | |__| | | |  | | | |__| | | |__| | |  ____| | |                |");
console.log("|          |_|     |_| |____|_| |_|  |_| |____|_| |____  | |______| |_|                |");
console.log("|                                                  ____| |                             |");
console.log("|                                                 |______|                             |");
console.log("|                                                                                      |");
console.log("|                                                                                      |");
